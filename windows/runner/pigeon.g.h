...
class MapLibreHostApi {
 public:
  ...
  virtual void AddVectorTileSource(
    const std::string& source_id,
    const flutter::EncodableList& tile_urls,
    int64_t min_zoom,
    int64_t max_zoom,
  ...
  virtual void SetSymbolLayerColors(
    const std::string& layer_id,
    const std::string* icon_color,
    const std::string* icon_halo_color,
    const std::string* text_color,
    const std::string* text_halo_color,
    std::function<void(std::optional<FlutterError> reply)> result) = 0;
